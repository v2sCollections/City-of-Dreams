...
This is a clothing and cosmetic Collection of Mods by one of the most renowned and Talented clothing authors for **Cyberpunk 2077**. When [Veegee](https://next.nexusmods.com/profile/VeegeeAlvarez) reached out to me to create this collection for her I was honoured, to say the least. This collection can be added to any set of mods providing you have one of the following body mods.
...
- **2**) Go to the [Collection](https://next.nexusmods.com/cyberpunk2077/collections/j559l9?utm_source=copy\&utm_medium=social\&utm_campaign=share_collection) page and ensure the most current revision number is displayed, then select **"ADD TO VORTEX"**
...
**Premium Users**: Takes 1 hour + Semi-automatic. You can be AFK.\
...
> 5+ Shops with over 2000+ pieces of Clothing, Armour, Cyberware, and Jewellery added to the Alteier store these can be accessed in-game from any computer.
...
- [VeegeeAlvarez](https://next.nexusmods.com/profile/VeegeeAlvarez)
- v2sCollections Team
...
If you would like to support Veegee so she can afford some new chrome click the button below and chuck her some eddies detes attached. Can't donate? I understand a simple thank you and endorsement is much appreciated.

[![](https://i.imgur.com/1OJWCCm.png)](https://ko-fi.com/veegee)
